package com.doctory_doctor.ui.chat_activity;
...
import com.doctory_doctor.adapters.Chat_Adapter;
import com.doctory_doctor.databinding.ActivityChatBinding;
...
import com.doctory_doctor.mvp.activity_chat_mvp.ActivityChatPresenter;
import com.doctory_doctor.mvp.activity_chat_mvp.ChatActivityView;
...
public class ChatActivity extends AppCompatActivity implements ChatActivityView {
    ...
    public void ondataload(MessageModel body) {
        preferences.create_update_ChatUserData(com.doctory_doctor.ui.chat_activity.ChatActivity.this, chatUserModel);
